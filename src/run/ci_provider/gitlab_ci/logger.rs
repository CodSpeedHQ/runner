...
impl Log for GitLabCILogger {
    ...
    fn log(&self, record: &log::Record) {
        ...
        match level {
            Level::Error => {
                println!("{CLI_RED}{message}{COLOR_RESET}");
            }
            Level::Warn => {
                println!("{CLI_YELLOW}{message}{COLOR_RESET}");
            }
            Level::Info => {
                println!("{message}");
            }
            Level::Debug => {
                println!("{CLI_CYAN}{message}{COLOR_RESET}");
            }
            Level::Trace => {
                println!("{CLI_MAGENTA}{message}{COLOR_RESET}");
            }
        };
    }
